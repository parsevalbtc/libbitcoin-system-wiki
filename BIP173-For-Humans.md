...
The maximum program length is deduced from `90 - a = 77`, but further limited to `4..64` base32 values (2-40 bytes) by [BIP141](https://github.com/bitcoin/bips/blob/master/bip-0141.mediawiki).

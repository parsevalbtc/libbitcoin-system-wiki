If one is not familiar with C++ template [overload resolution](https://en.cppreference.com/w/cpp/language/overload_resolution), the use of [enable_if](https://en.cppreference.com/w/cpp/types/enable_if) and [enable_if_t](https://en.cppreference.com/w/cpp/types/enable_if_t) to constrain template parameters can be a little hard to follow. While these are provided by C++11 and C++14 respectively, they are trivially implemented as follows.
```cpp
